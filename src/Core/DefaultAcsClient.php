...
use Video\Core\Auth\RamRoleArnService;
use Video\Core\Auth\EcsRamRoleService;
use Video\Core\Exception\ClientException;
use Video\Core\Regions\EndpointProvider;
use Video\Core\Http\HttpHelper;
use Video\Core\Exception\ServerException;
