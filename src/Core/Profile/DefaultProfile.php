...
namespace Video\Core\Profile;
use Video\Core\Auth\Credential;
use Video\Core\Auth\RamRoleArnCredential;
use Video\Core\Auth\EcsRamRoleCredential;
use Video\Core\Auth\ShaHmac1Signer;
use Video\Core\Regions\EndpointProvider;
use Video\Core\Regions\LocationService;
use Video\Core\Regions\ProductDomain;
use Video\Core\Regions\Endpoint;
